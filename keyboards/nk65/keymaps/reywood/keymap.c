...
[1] = LAYOUT_65_ansi( /* FN */
    ...
    ______,  ______,  ______,   KC_UP,  ______,  ______,  ______,  ______,   KC_UP,  ______,  ______,  ______,  ______,   RESET,  ______,\
    KC_CAPS, ______, KC_LEFT, KC_DOWN, KC_RGHT,  ______,  ______, KC_LEFT, KC_DOWN, KC_RGHT,  ______,  ______,           ______,  ______,\
    ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______,          KC_VOLU,  ______,\
    ______,  ______,  ______,                     KC_MPLY,                          ______,  ______,   MO(2),  ______, KC_VOLD,  ______),
