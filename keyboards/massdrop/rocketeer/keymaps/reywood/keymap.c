...
#define RSFT_UP     MT(MOD_RSFT, KC_UP)
#define RALT_DOWN   MT(MOD_RALT, KC_DOWN)
#define FN_LEFT     LT(1, KC_LEFT)
#define RCTL_RGHT   MT(MOD_RCTL, KC_RGHT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                     KC_SPC,                             KC_RGUI,   FN_LEFT,  RALT_DOWN,     RCTL_RGHT\
    ),
    [1] = LAYOUT(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_VOLD,  KC_VOLU,  KC_DEL,  \
        _______,  KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, _______, L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______,  U_T_AGCR,\
        _______,   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______,          _______, \
        _______,    _______, _______, _______, _______, MD_BOOT, TG_NKRO, _______, L_T_MD,  L_T_ONF, _______,                  _______, \
