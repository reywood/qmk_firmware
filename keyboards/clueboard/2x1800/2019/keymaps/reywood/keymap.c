...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LD] = LAYOUT_2u_ansi( \
        ...
        ______,  ______,  ______,  ______,    ______,    ______,  ______,  ______,  ______,  ______,  ______,  ______,  ______, ______, ______, ______,   ______,       CK_UP,        ______,  ______,  ______,  ______, \
                 ______,  ______,    ______,  ______,  ______,    ______,  ______,  ______,  ______,   MU_TOG,  MU_MOD, ______,  ______,  ______, ______,      CK_TOGG, CK_DOWN,  CK_RST,      ______,  ______           \
    ),
};
