 ...
 */
  ...
  LAYOUT_2_shifts(
      ...
      KC_LSFT, ______, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_PGDN, KC_UP, KC_PGUP,
 ...
 */
  ...
  LAYOUT_directional(
      KC_GRV, BL_TOGG, BL_STEP, BL_DEC, BL_INC, ______, ______, ______, ______, ______, ______, ______, ______, ______, RESET,
